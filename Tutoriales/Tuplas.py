#Las tuplas no se pueden modificas
...
tupla5=()#* se puede crear una tupla vacía, pero es extraño, ya que no se puede modificar
pi = (3.14159) #* no se puede crear una tupla con un solo valor
p2 = (3.14159,)#* de esta manera podemos crear un solo valor con tuplas
print(p2)

#*Se puede convertir entre tupla a lista
tupla6 = tuple(["hola","mi","darlin"]) #! de list a tupla
print(tupla6)
lista = list(tupla4)#! de tupla a lista
print(lista)
